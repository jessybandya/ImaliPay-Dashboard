...
const Defaulters = () => {
  ...
  return (
    ...
    <div className="head-title">
        <div className="left">
        <span style={{fontWeight:'500',fontSize:24}} className='text-4xl text-[#222222] dark:text-[#fff]'>Fulfilment</span>

        </div>
        <button style={{
          width:97,
          height:45,
          backgroundColor:'#014342',
          borderRadius:10,
          padding:10,
          fontWeight:'600',
          fontSize:16,
             ...
             .map((row) => {
               ...
               return (
                 ...
                 >
                   ...
                   <TableCell align="center"
                   >
                   <span style={{fontSize:12, fontWeight:'500',color:'#101010'}}>Mazda - Model Q</span>
                   </TableCell>
                   ...
                   <TableCell align="center"
                   >
                   <Link to='/fulfilment-details'>
                   <VisibilityOutlinedIcon style={{color:"#667085"}}/>
                   </Link>
                   </TableCell>
                 </TableRow>
